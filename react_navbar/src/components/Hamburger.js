                    ...
                    <div className="wrapper">
                        <div className="menu-links">
                            ...
                            <div ref={el => (info = el)} className="info">
                                <h3>Our Promise</h3>
                                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolor a excepturi nihil ipsum. Delectus tempora quibusdam quia nemo repudiandae maxime culpa ea quaerat reprehenderit illo eius, alias quas est architecto.</p>
                            </div>
                            <div className="locations">
                                Locations: 
                                {cities.map((el) => {
                                    return <span key={el.name} onMouseEnter = {() => handleCity(el.image)} onMouseOut={handleCityReturn} >{el.name}</span>
                                })}
                            </div>
                        </div>
                    </div>
